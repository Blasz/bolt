...
function runCommandFromCli(args, flags) {
  var command = args[0],
    commandArgs = args.slice(1);
  var subCommand = commandArgs[0],
    subCommandArgs = commandArgs.slice(1);
  ...
  if (commandMap.ADD[command]) {
    ...
    var workspaceCommand = subCommandArgs[0],
      rest = subCommandArgs.slice(1);

    var workspaceArgs = [subCommand].concat(rest);
    if (commandMap.WORKSPACE_ADD[workspaceCommand]) {
      ...
      return commands.workspaceRun(
        commands.toWorkspaceRunOptions(
          [subCommand].concat(subCommandArgs),
          flags
        )
      );
    }
  ...
  throw new _errors.BoltError(`You must specify a valid command`);
}

exports.default = (function() {
  var _ref = (0, _asyncToGenerator3.default)(
    _regenerator2.default.mark(function _callee(argv) {
      var exit =
        arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1]
          : false;

      var start, _meow, pkg, input, flags, timing, rounded;
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                _context.prev = 4;
                _context.next = 7;
                return runCommandFromCli(input, flags);
              ...
              case 9:
                ...
                if (_context.t0 instanceof _errors.BoltError) {
                  logger.error(_context.t0.message);
                } else {
                  logger.error((0, _cleanStack2.default)(_context.t0.stack));
                }
