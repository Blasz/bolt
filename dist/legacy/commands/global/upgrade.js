...
exports.globalUpgrade = undefined;
...
var globalUpgrade = (exports.globalUpgrade = (function() {
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return yarn.globalCli('upgrade', opts.deps);
  ...
  return function globalUpgrade(_x) {
    return _ref.apply(this, arguments);
  };
})());

exports.toGlobalUpgradeOptions = toGlobalUpgradeOptions;
...
function toGlobalUpgradeOptions(args, flags) {
  var depsArgs = [];
